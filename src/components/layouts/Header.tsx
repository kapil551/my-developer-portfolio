        ...
        <ul className="flex justify-center flex-auto tracking-wide space-x-14 ">
          ...
          <li className="cursor-pointer">
            <a aria-label="about" href="#about">
              <SiAboutdotme className="block w-5 h-5 md:hidden" />
              <span className="hidden md:block">About</span>
            </a>
          </li>
          <li className="cursor-pointer">
            <a aria-label="about" href="#education">
              <GiGraduateCap className="block w-5 h-5 md:hidden" />
          ...
          <li className="cursor-pointer">
            <a aria-label="YouTube" href="#certificates">
              <AiFillCode className="block w-5 h-5 md:hidden" />
